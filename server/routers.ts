...
## 数値フィールドの現実的な範囲（範囲外の値は読み違いの可能性が高い）
- **Hole番号**: 1〜18（2桁の場合は10〜18）
- **Date**: 西暦4桁（2020〜2030）+ 月2桁（01〜12）+ 日2桁（01〜31）
- **Dist(prev) yd**: 通常1〜30yd。100超は稀（長いパット）。3桁欄だが実際は1〜2桁が多い
- **Length Steps（歩数 st）**: 通常1〜30歩。「15st」なら15
- **Length Meters（距離 m）**: 通常0.5〜20m。「8m」なら8
- **Touch（タッチ）1〜5**: 1=弱い、3=普通、5=強い
- **Missed Direction 1〜5**: 1〜5のいずれか1つ（5択）
- **Mental P/1〜5/N**: P=ポジティブ、1〜5=中間、N=ネガティブ
- 範囲外の数値（例: Steps=99、Meters=50）が読み取れた場合は null を返すこと
